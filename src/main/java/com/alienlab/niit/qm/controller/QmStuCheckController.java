...
public class QmStuCheckController {
    ...
    @ApiOperation(value="查看考勤记录")
    @GetMapping (value="/attendRecord")
    public ResponseEntity getattendRecord(@RequestParam long scheNo,@RequestParam String termNo){

        List<AttendanceDto> attendanceDtos = qmStuCheckService.getByScheNoAndTermNo(scheNo,termNo);
